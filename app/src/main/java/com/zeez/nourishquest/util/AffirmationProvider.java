...
// Provides daily IE-aligned affirmations.
// Rotates by day of year — no network call needed.
// The banned-phrase test in AffirmationProviderTest guards against diet-culture language creeping in.
public final class AffirmationProvider {
    ...
    private static final String[] AFFIRMATIONS = {
        ...
        "I am exactly where I need to be in my IE journey.",
    };

    // Returns today's affirmation — cycles through the list by day of year
